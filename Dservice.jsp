...
String data = ("delete  from Business.Service where ServiceID='"+no+"'");
...
<p> Ви не можете видалити дані, оскільки вони використовуються! <a href="Sservice.jsp" class="btn btn-default">Назад</a></p>
 </div>
 <% }%>
